...
jal x1, soma2
pass7:
addi x14, x0, 84 # muda a variavel de controle para o valor de 'T'
bne x13, x14, pass8 # confere se é 
jal x1, soma2

# somas para 3
pass8:
addi x14, x0, 66 # muda a variavel de controle para o valor de 'B'
bne x13, x14, pass9 # confere se é 
jal x1, soma3
pass9:
addi x14, x0, 67 # muda a variavel de controle para o valor de 'C'
bne x13, x14, pass10 # confere se é 
jal x1, soma3
pass10:
addi x14, x0, 77 # muda a variavel de controle para o valor de 'M'
bne x13, x14, pass11 # confere se é 
jal x1, soma3
pass11:
addi x14, x0, 78 # muda a variavel de controle para o valor de 'N'
bne x13, x14, pass12 # confere se é 
jal x1, soma3
pass12:
addi x14, x0, 80 # muda a variavel de controle para o valor de 'P'
bne x13, x14, pass13 # confere se é 
jal x1, soma3

# somas para 4
pass13:
addi x14, x0, 70 # muda a variavel de controle para o valor de 'F'
bne x13, x14, pass14 # confere se é 
jal x1, soma4
pass14:
addi x14, x0, 72 # muda a variavel de controle para o valor de 'H'
bne x13, x14, pass15 # confere se é 
jal x1, soma4
pass15:
addi x14, x0, 86 # muda a variavel de controle para o valor de 'V'
bne x13, x14, pass16 # confere se é 
jal x1, soma4
pass16:
addi x14, x0, 87 # muda a variavel de controle para o valor de 'W'
bne x13, x14, pass17 # confere se é 
jal x1, soma4
pass17:
addi x14, x0, 89 # muda a variavel de controle para o valor de 'Y'
bne x13, x14, pass18 # confere se é 
jal x1, soma4

# somas para 5
pass18:
addi x14, x0, 75 # muda a variavel de controle para o valor de 'K'
bne x13, x14, pass19 # confere se é 
jal x1, soma5
pass19:
addi x14, x0, 82 # muda a variavel de controle para o valor de 'R'
bne x13, x14, pass20 # confere se é 
jal x1, soma5
pass20:
addi x14, x0, 83 # muda a variavel de controle para o valor de 'S'
bne x13, x14, pass21 # confere se é 
jal x1, soma5

# somas para 8
pass21:
addi x14, x0, 74 # muda a variavel de controle para o valor de 'J'
bne x13, x14, pass22 # confere se é 
jal x1, soma8
pass22:
addi x14, x0, 76 # muda a variavel de controle para o valor de 'L'
bne x13, x14, pass23 # confere se é 
jal x1, soma8
pass23:
addi x14, x0, 88 # muda a variavel de controle para o valor de 'X'
bne x13, x14, pass24 # confere se é 
jal x1, soma8

# somas para 10
pass24:
addi x14, x0, 81 # muda a variavel de controle para o valor de 'Q'
bne x13, x14, pass25 # confere se é 
jal x1, soma10
pass25:
addi x14, x0, 90 # muda a variavel de controle para o valor de 'Z'
