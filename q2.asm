...
sb x11, 1024(x0) # Printa o primeiro agarismo
bne x11, x10, pass2
addi x21, x0, -99 # se tiver o sinal negativo, é necessariamente menor que 62, então atribui um valor sempre menor que 64
lb x11, 1025(x0) # Se for um sinal de menos, ele lê de novo
sb x11, 1024(x0) # Printa o algarismo
...
jump: 
bge x26, x21, jump_2 # comparar para ver se b <= 62
add x9, x0, x0 

jump_2: 
blt x25, x22, end # comparar para ver se c > 15
add x9, x0, x0
